...
pool_spec_orphans_ = True # False # True
enable_known_mu_ = True # False # True
enable_blind_mu_ = True # False # True
show_XXX_targets_ = True # False # True
...
two_spotter_use_ = 2 # [0: dont use], [1 : divide 16], [2 : div locations]
...
print_ideal_cov_ = False # False # True
...
#mutation_file_name_ = 'predefined_mutations_run075.txt'
mutation_file_name_ = 'predefined_mutations_random_sim_4.txt'
...
def pool_spec_orphans():
    return pool_spec_orphans_
def ideal_cov():
    return ideal_cov_    
def enable_known_mu():
